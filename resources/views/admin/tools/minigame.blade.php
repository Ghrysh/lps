...
<body>
    ...
    <div id="intro-screen" class="bg-intro fixed inset-0 flex items-center justify-center overflow-hidden">
        ...
        <div class="text-center z-10 px-6 max-w-2xl mx-auto">
            ...
            <div class="scale-in mb-8">
                <div class="icon-badge pulse-glow mx-auto"
                    style="width: 100px; height: 100px; background: linear-gradient(135deg, #FF6B35, #FFA726); border-color: rgba(255, 107, 53, 0.3);">
            ...
            <div class="flex justify-center gap-4 mb-12 fade-in-up" style="animation-delay: 0.2s;">
                <div class="glass rounded-2xl px-6 py-4 min-w-[120px] border-2 border-orange-200">
                    <div class="text-gradient-orange text-3xl font-bold mb-1">{{ count($questions) }}</div>
    ...
    <div id="game-screen" class="bg-game fixed inset-0 hidden flex-col overflow-hidden">
        ...
        <div class="relative z-10 p-4 md:p-6 flex justify-between items-center">
            ...
            <div class="hud-badge fade-in-down">
                ...
                <span class="text-lg font-bold">
                    <span id="q-number">1</span>/<span>{{ count($questions) }}</span>
                </span>
            </div>
        ...
        <!-- Answers -->
        <div id="answers-container" class="px-4 md:px-8 pb-8 flex-1 overflow-y-auto"
    ...
    <div id="result-screen" class="bg-result fixed inset-0 hidden items-center justify-center overflow-hidden">
        ...
        <div class="text-center z-10 px-6 max-w-2xl mx-auto">
            ...
            <div class="scale-in mb-8">
                <div class="icon-badge pulse-glow mx-auto"
                    style="width: 120px; height: 120px; background: linear-gradient(135deg, #FF6B35, #FFA726); border-color: rgba(255, 107, 53, 0.3);"
            ...
            <div class="grid grid-cols-2 gap-4 mb-10 fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="stat-card">
                    <div
                        class="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-3 border-2 border-green-500/30">
                ...
                <div class="stat-card">
                    <div
                        class="w-12 h-12 rounded-full bg-red-500/20 flex items-center justify-center mx-auto mb-3 border-2 border-red-500/30">
    ...
    <script>
        ...
        async function savePointToDB(score) {
            try {
                // Pastikan nilai tidak negatif
                if (score < 0) score = 0;

                const response = await fetch("{{ route('minigame.save') }}", {
                    method: 'POST',
                    headers: {
                ...
                if (result.success) {
                    console.log('Poin berhasil disimpan!');
                    // Opsional: Notifikasi kecil di pojok
