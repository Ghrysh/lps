        ...
        <nav class="flex-grow py-6 overflow-y-auto px-4 space-y-1">
            ...
            <div>
                ...
                <div id="masterDropdown"
                    ...
                    <a href="<?php echo e(route('admin.photobooth')); ?>"
                        class="<?php echo e(request()->routeIs('admin.photobooth') ? 'text-emerald-600 font-medium bg-emerald-50' : 'text-slate-500 hover:text-slate-800'); ?> block px-4 py-2 text-sm rounded-lg transition border-l-2 <?php echo e(request()->routeIs('admin.photobooth') ? 'border-emerald-500' : 'border-transparent hover:border-slate-300'); ?>">
                    ...
                    <a href="<?php echo e(route('tools.minigame')); ?>"
                        class="<?php echo e(request()->routeIs('tools.minigame') ? 'text-emerald-600 font-medium bg-emerald-50' : 'text-slate-500 hover:text-slate-800'); ?> block px-4 py-2 text-sm rounded-lg transition border-l-2 <?php echo e(request()->routeIs('tools.minigame') ? 'border-emerald-500' : 'border-transparent hover:border-slate-300'); ?>">
