...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - LPS</title>
    ...
    <aside id="sidebar"
        ...
        <nav class="flex-grow py-4 overflow-y-auto">
            <a href="<?php echo e(route('admin.dashboard')); ?>"
                class="<?php echo e(request()->routeIs('admin.dashboard') ? 'sidebar-active text-white font-semibold' : 'text-orange-50'); ?> flex items-center px-6 py-3 text-sm hover:bg-white/10 transition">
            ...
            <div class="mt-2">
                ...
                <div id="masterDropdown"
                    ...
                    <a href="<?php echo e(route('admin.gallery.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.gallery.*') ? 'sidebar-active text-white' : 'text-orange-100'); ?> flex items-center pl-14 pr-6 py-2 text-sm hover:bg-white/10 transition">
        ...
        <div class="p-4 border-t border-white/20 flex items-center justify-between bg-orange-800/50">
            <div class="flex items-center space-x-3 overflow-hidden">
                ...
                <div class="text-[10px] truncate text-orange-50"><?php echo e(auth()->user()->email ?? 'admin@lps.go.id'); ?>
