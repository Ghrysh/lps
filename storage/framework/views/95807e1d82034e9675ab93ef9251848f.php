<?php $__env->startSection('title', 'Object Recognition AR'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        function fetchDetail(filename) {
            ...
            fetch('<?php echo e(route('admin.asset.detail')); ?>', { method: 'POST', body: formData })
            .then(res => res.json())
            .then(res => {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tools/scanner.blade.php ENDPATH**/ ?>