...
<?php $__env->startSection('title', 'AI Photobooth'); ?>
        ...
        <div id="setupWizard" class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 h-full flex flex-col">
            ...
            <div id="step3" class="hidden animate-in fade-in slide-in-from-right duration-300">
                ...
                <div class="space-y-2 overflow-y-auto max-h-[300px] pr-1 mb-4">
                    ...
                    <div onclick="selectTheme('<?php echo e($baju['id']); ?>', this)" 
                        ...
                        <div>
                            <p class="text-sm font-bold text-slate-700"><?php echo e($baju['name']); ?></p>
                            <p class="text-[10px] text-slate-400 leading-none"><?php echo e($baju['description']); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tools/photobooth.blade.php ENDPATH**/ ?>