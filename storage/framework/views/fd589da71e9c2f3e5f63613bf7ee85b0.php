<?php $__env->startSection('title', 'Galeri LPS'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-xl overflow-hidden shadow-sm group">
                ...
                <div class="p-4">
                    <h4 class="font-bold text-slate-800"><?php echo e($img->title); ?></h4>
                    <p class="text-[11px] text-slate-500 line-clamp-2"><?php echo e($img->description); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tools/gallery.blade.php ENDPATH**/ ?>